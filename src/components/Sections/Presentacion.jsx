...
function Presentacion() {
  ...
  return (
    <>
      <section id="presentacion" className='w-full py-2 px-5 md:px-40 lg:px-60'>
        <h1 className={`text-2xl text-center font-bold theme-${theme}:text-${theme}-text-1`}>{t('presentation.title')}</h1>
