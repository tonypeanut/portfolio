  ...
  return (
    <>
      <div className=' w-full flex justify-center p-1' >
          ...
          <a href={t('cv')} target='_blank'><img className=" p-0.5 ml-3 mr3 hover:shadow hover:shadow-cyan-400 hover:bg-cyan-400" src={curriculumVitaeSVG} alt="curriculum vitae" width={`${size}px`}/></a>
      </div>
    </>
  )
}
