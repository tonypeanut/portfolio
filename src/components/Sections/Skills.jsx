...
const Skills = ({ datosSkills, datosSoftskills }) => {
  ...
  return (
    <>
      ...
      <section id="skills" className='w-full py-2 px-5 md:px-40 lg:px-60'>
        <h1 className={`text-2xl text-center font-bold theme-${theme}:text-${theme}-text-1`}>{t('skills.title-1')}</h1>
        <div className={`rounded p-5 flex flex-wrap gap-2 theme-${theme}:bg-${theme}-color-2 theme-${theme}:text-${theme}-text-1`}>
      ...
      <section className='w-full py-2 px-5 md:px-40 lg:px-60'>
        <h1 className={`text-2xl text-center font-bold theme-${theme}:text-${theme}-text-1`}>{t('skills.title-2')}</h1>
        <div className= {`rounded p-5 flex flex-wrap gap-2 theme-${theme}:bg-${theme}-color-2 theme-${theme}:text-${theme}-text-1`}>
