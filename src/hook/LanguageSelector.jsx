...
const LanguageSelector = () => {
  ...
  return (
    <div className='pt-1'>
      <div 
        className="static w-full flex justify-evenly bg-gray-50 p-4 shadow-none rounded-none md:fixed md:top-16 md:right-4 md:w-auto md:bg-white md:shadow-lg md:rounded-lg md:z-50 md:flex-col md:items-center mt-[60px] md:mt-0"
      >
        <button
